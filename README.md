<div align="center">
  ...
  <img src="https://raw.githubusercontent.com/good-bad-code/Entry-Sync/main/extension/icon128.png" alt="Entry Sync Logo" width="100" height="100" style="border-radius: 20px; box-shadow: 0 8px 24px rgba(0, 210, 255, 0.4);" />
  ...
  <p align="center">
    <a href="https://good-bad-code.github.io/entry-sync-extension/"><img src="https://img.shields.io/badge/Official%20Site-Visit%20Website-00d2ff?style=for-the-badge&logo=googlechrome&logoColor=white" alt="Official Website" /></a>
    ...
    <a href="https://github.com/good-bad-code/entry-sync-extension/blob/main/%EA%B0%9C%EC%9D%B8%EC%A0%95%EB%B3%B4%EC%B2%98%EB%A6%AC%EB%B0%A9%EC%B9%A8.md"><img src="https://img.shields.io/badge/Privacy%20Policy-Zero%20PII-10b981?style=for-the-badge&logo=shield&logoColor=white" alt="Privacy Policy" /></a>
  </p>
...
```mermaid
flowchart LR
    subgraph Client ["🖥️ Client (사용자 브라우저)"]
        Entry["엔트리 플레이어\n(playentry.org)"]
        Ext["Entry Sync\nChrome 확장프로그램"]
    ...
    style Client fill:#101524,stroke:#00d2ff,stroke-width:2px,color:#fff
    style Cloudflare fill:#181729,stroke:#f38020,stroke-width:2px,color:#fff
    style Google fill:#1f1917,stroke:#ffca28,stroke-width:2px,color:#fff
```
...
### 1단계: 확장프로그램 설치
- [Chrome 웹 스토어](https://chromewebstore.google.com)에서 **Entry Sync**를 설치하거나, 저장소를 클론하여 `chrome://extensions`에서 '압축해제된 확장프로그램 로드'를 통해 설치합니다.
...
## 🛡️ 보안 및 개인정보 보호 (Privacy & Security)
...
- 📋 **투명한 정책**: 자세한 내용은 [개인정보처리방침.md](./개인정보처리방침.md) 또는 [온라인 개인정보처리방침](https://good-bad-code.github.io/entry-sync-extension/privacy)에서 확인하실 수 있습니다.
...
- **버그 제보 및 기능 제안:** [GitHub Issues](https://github.com/good-bad-code/entry-sync-extension/issues)
- **개발팀 문의 이메일:** `goodbadcode.official@gmail.com`
- **공식 웹사이트:** [https://good-bad-code.github.io/entry-sync-extension/](https://good-bad-code.github.io/entry-sync-extension/)
